...
def config():
    ...
    parser.add_argument("--matcher", default=60, type=int, required=False, help="Use resume matcher to filter job positions. Specify a percentage (0-100) for matching threshold.")
